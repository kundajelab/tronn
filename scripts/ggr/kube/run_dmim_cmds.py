    ...
    if START_JOBS:
        ...
        for job_set in sorted(jobs.keys()):
            ...
            for idx in jobs[job_set]:
                ...
                adjust_job_name = "sed -i -e 's/traj-[0-9,-]\+/traj-{}/g' {}".format(idx.replace(",", "-"), job_file)
                ...
                adjust_job_foreground_name = "sed -i -e 's/LABELS-[0-9,-]\+/LABELS-{}/g' {}".format(idx.replace(",", "-"), job_file)
