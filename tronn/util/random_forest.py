...
def get_default_head(params, weights_name, name=None):
  ...
  return head_lib.multi_label_head(
    params.num_classes,
...
def get_model_fn(params,
  ...
  def _model_fn(features, labels, mode):
    ...
    logits = graph_builder.inference_graph(features) # this is what I want
    #logits = array_ops.expand_dims(logits, 2)
